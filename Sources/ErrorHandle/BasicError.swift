...
/**
    ...
    ``` swift
     ...
     func demo() throws {
         ...
         throw A.error1.d("一些错误解释，即 explain", 1001, category: .internal)
         ...
     }
...
*/
@frozen
public struct BasicError<ErrorList>: Err, Sendable where ErrorList: ErrList & Sendable {
    /// 该错误的错误枚举值。
    public var error: ErrorList!
    /// 该错误的类型
    public var category: ErrCategory!
    ...
    @inlinable
    public init(category: ErrCategory) { self.category = category }
}
